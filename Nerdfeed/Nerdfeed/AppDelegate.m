...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BNRCoursesViewTableViewController *cvc=[[BNRCoursesViewTableViewController alloc]initWithStyle:UITableViewStylePlain];
   ...
   //检查当前设备是否是iPad
    if([[UIDevice currentDevice] userInterfaceIdiom]==UIUserInterfaceIdiomPad)
    {
        ...
        //将UISplitViewController对象设置为UIWindow对象的跟视图控制器
